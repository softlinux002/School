<%@ Page Title="" Language="C#" MasterPageFile="~/Hostel/hostelMasterPage.master" AutoEventWireup="true" CodeFile="Changepassword.aspx.cs" Inherits="Hostel_Changepassword" %>
...
<div class="form-horizontal">
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
        ...
        <asp:Label ID="Label1" runat="server" Text="" Visible="false"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="Text_oldpass" ForeColor="Red" ValidationGroup="ans"></asp:RequiredFieldValidator>    
