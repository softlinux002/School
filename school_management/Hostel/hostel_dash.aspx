<%@ Page Title="" Language="C#" MasterPageFile="~/Hostel/hostelMasterPage.master" AutoEventWireup="true" CodeFile="hostel_dash.aspx.cs" Inherits="Hostel_hostel_dash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-content-wrap">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <div class="row">
                <div class="col-md-2">
                    <a href="Hostel.aspx" class="tile tile-primary tile-valign">
                        <img src="../dash/Hostel.png" height="80px" width="90px"/>
                    <p style="font-size: 20px;font-family:Cursive;">Hostel</p>
                ...
                <div class="col-md-2">
                    <a href="hosteltype.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="hostel_fee.aspx" class="tile tile-primary tile-valign">
                 ...
                 <div class="col-md-2">
                    <a href="Refundfee.aspx" class="tile tile-primary tile-valign">
                      <img src="../dash/fee.png" height="80px" width="90px"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                            Refund Fee</p>
                        <div class="informer informer-default dir-bl">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="Search_fee.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="StudentReport.aspx" class="tile tile-primary tile-valign">
