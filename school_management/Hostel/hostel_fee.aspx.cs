...
public partial class Hostel_hostel_fee : System.Web.UI.Page
{
    ...
    //public void hostelid()
    //{
    //    SqlDataAdapter da = new SqlDataAdapter("Select * from student_hostelinfo", con);
    //    DataTable dt = new DataTable();
    //    da.Fill(dt);
    //    student_ddl.DataSource = dt;
    //    student_ddl.DataTextField = "student_id";
    //    student_ddl.DataValueField = "pk_id";
    //    student_ddl.DataBind();
    //    student_ddl.Items.Insert(0, "Select id");
    ...
    {
        con.Open();
        SqlCommand com = new SqlCommand("Select * from hostel_fee where student_id='" + student_ddl.Text + "'", con);
        com.ExecuteNonQuery();
        ...
        {
            dr1.Close();
            SqlCommand cmd = new SqlCommand("select * from student_hostelinfo where student_id='" + student_ddl.Text + "'", con);
            cmd.ExecuteNonQuery();
