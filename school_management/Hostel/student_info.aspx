<%@ Page Title="" Language="C#" MasterPageFile="~/Hostel/hostelMasterPage.master" AutoEventWireup="true" CodeFile="student_info.aspx.cs" Inherits="Hostel_student_info" EnableEventValidation="false"%>
                            ...
                            AllowPaging="true" PageSize="10" onpageindexchanging="GridView1_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Country">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_country" runat="server" Text='<%#Eval("country") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
