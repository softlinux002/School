<%@ Page Title="" Language="C#" MasterPageFile="~/Parent/parentMaster.master" AutoEventWireup="true" CodeFile="parent_dashboard.aspx.cs" Inherits="Parent_parent_dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-content-wrap">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <div class="row">
                <div class="col-md-2">
                    <a href="student_attendance_search.aspx" class="tile tile-primary tile-valign">
                    ...
                    <p style="font-size: 20px;font-family:Cursive;">Search Attandance</p>
                ...
                <div class="col-md-2">
                    <a href="student_marks.aspx" class="tile tile-primary tile-valign">
                    ...
                    <p style="font-size: 20px;font-family:Cursive;">Student Marks</p>
                        <div class="informer informer-default dir-bl">
                ...
                <div class="col-md-2">
                    <a href="fee_Search.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Transport_fee_show.aspx" class="tile tile-primary tile-valign">
                      <img src="../dash/fee.png" height="80px" width="90px" onkeydown="return DisableControlKey(event)" onmousedown="return DisableControlKey(event)"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                            Transport Fee</p>
                        <div class="informer informer-default dir-bl">
                 ...
                 <div class="col-md-2">
                    <a href="Parent_review.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="Search_student_complaint.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="show_notice.aspx" class="tile tile-primary tile-valign">
                    ...
                    <p style="font-size: 20px;font-family:Cursive;">Show Notice</p>
                ...
                <div class="col-md-2">
                    <a href="show_event.aspx" class="tile tile-primary tile-valign">
