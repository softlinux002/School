...
public partial class Teacher_search_teacher_attendance : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM teacher_info where email='" + Session["teach_email"].ToString() + "' and password='" + Session["teach_pass"].ToString() + "';SELECT * FROM teach_tdaytbl_view where email='" + Session["teach_email"].ToString() + "' and password='" + Session["teach_pass"].ToString() + "'", con);
    ...
    protected void search_btn_click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem itm in Repeater2.Items)
        {
            ...
            foreach (RepeaterItem itmm in rptr.Items)
            {
                ...
                if (i <= dayinmonth)
                {
                    SqlCommand cmd = new SqlCommand("select * from search_teach_atten where day='" + i + "' and teacher_name='" + tname.Text + "' and teacher_tid='" + tid.Text + "' and month='" + MonthLabel.Text + "' and year='" + YearLabel.Text + "' and email='" + Session["teach_email"].ToString() + "' and password='" + Session["teach_pass"].ToString() + "'", con);
