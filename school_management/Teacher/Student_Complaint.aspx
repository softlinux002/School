<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="Student_Complaint.aspx.cs" Inherits="Teacher_Student_Complaint" EnableEventValidation="false" %>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12"> 
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_complaint" ValidationGroup="ans"></asp:RequiredFieldValidator>  
                                        </div>
                                    </div>
