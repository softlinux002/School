<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="Teacherdashboard.aspx.cs" Inherits="Teacher_Teacherdashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!-- PAGE TITLE -->
    <div class="page-title" style="font-family:Cursive;">
        <h2>
    ...
    <div class="page-content-wrap">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <div class="row">
                <div class="col-md-2">
                    <a href="student_attendance.aspx" class="tile tile-primary tile-valign">
                    ...
                    <p style="font-size: 20px;font-family:Cursive;">Student Attandence</p>
                ...
                <div class="col-md-2">
                    <a href="Teacher_viewmarks.aspx" class="tile tile-primary tile-valign">
                    ...
                    <p style="font-size: 20px;font-family:Cursive;">Student Result</p>
                        <div class="informer informer-default dir-bl">
                ...
                <div class="col-md-2">
                    <a href="search_teacher_attendance.aspx" class="tile tile-primary tile-valign">
                      <img src="../dash/attandance.png" height="53px" width="80px" onkeydown="return DisableControlKey(event)" onmousedown="return DisableControlKey(event)"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                            View Teacher Attendance</p>
                        <div class="informer informer-default dir-bl">
                            <%--<span class="fa fa-laptop"></span>--%>
                        </div>
                    </a>
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                    <a href="parentreview.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="Time_tablesview.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Syllabusdownload.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Eventview.aspx" class="tile tile-primary tile-valign">
                  ...
                  <div class="col-md-2">
                    <a href="daily_dairy.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="Leaveform.aspx" class="tile tile-primary tile-valign">
               ...
               <div class="col-md-2">
                    <a href="changepassword.aspx" class="tile tile-primary tile-valign">
