<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="search_employee_attendance.aspx.cs" Inherits="Admin_search_employee_attendance" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Search Employee</strong></h3>
                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">EmployeeId</label>
                                        <div class="col-md-6 col-xs-12"> 
                                    <asp:DropDownList ID="emp_id_ddl" runat="server" class="form-control" AutoPostBack="true"
                             ...
                             <div class="form-group">
                                 ...
                                 <asp:Label ID="Label2" runat="server" Text="" class="form-control"></asp:Label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12"> 
                                 <asp:Label ID="Label3" runat="server" Text="" class="form-control"></asp:Label>
                                        </div>
                                    </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Teacher Id">
                                     ...
                                     <asp:TemplateField HeaderText="Teacher Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_tname" runat="server" Text='<%#Eval("emp_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_date" runat="server" Text='<%#Eval("day") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
