<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="add_school_img.aspx.cs" Inherits="Admin_add_school_img" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="Label" Visible="false"></asp:Label>
         ...
         <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div class="form-group">
                                        ...
                                        <asp:TextBox ID="school_txt" runat="server" class="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="school_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>     
                                        </div>
                                    </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="School Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_name" runat="server" Text='<%#Eval("school_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
