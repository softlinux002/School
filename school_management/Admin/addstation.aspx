<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="addstation.aspx.cs" Inherits="Admin_addstation" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Station</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                     ...
                                     <asp:DropDownList ID="ddl_routename" runat="server"  class="form-control select" >
                                     </asp:DropDownList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="ddl_routename" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Station Point</label>
                                        <div class="col-md-6 col-xs-12"> 
                                    <asp:TextBox ID="Text_stationpoint" runat="server"  class="form-control select"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_stationpoint" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Route Name">
                                     ...
                                     <asp:TemplateField HeaderText="Station Point">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_spoint" runat="server" Text='<%#Eval("station_point") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
