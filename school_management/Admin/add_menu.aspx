<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="add_menu.aspx.cs" Inherits="Admin_add_menu" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Menu</strong></h3>
                                ...
                                <div class="panel-body">      
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="menu_text" runat="server" class="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="menu_text" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>

                                        <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Menu URL</label>
                                        <div class="col-md-6 col-xs-12"> 
                                        <asp:TextBox ID="Menu_url" runat="server" class="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Menu_url" ValidationGroup="ans">
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbl_id" Visible="false" runat="server" Text='<%#Eval("Menu_id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Menu Url">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_murl" runat="server" Text='<%#Eval("Menu_url") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
