<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="add_fair.aspx.cs" Inherits="Admin_add_fair" EnableEventValidation="false" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Allocate Student to Station</strong></h3>
                                ...
                                <div class="panel-body">  
                                     ...
                                     <asp:DropDownList ID="ddl_stationname" runat="server" class="form-control select" >   
                                     </asp:DropDownList>
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Both Way Fare</label>
                                        <div class="col-md-6 col-xs-12"> 
                                         <asp:TextBox ID="Text_bothway" runat="server" class="form-control select"></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_bothway" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>

                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> One Way Fare</label>
                                        <div class="col-md-6 col-xs-12"> 
                                         <asp:TextBox ID="Text_one" runat="server" class="form-control select"></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" 
                                         ControlToValidate="Text_one" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Both Way">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_both_way" runat="server" Text='<%#Eval("Both_way_fare") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                       <asp:TemplateField HeaderText="One way">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_oneway" runat="server" Text='<%#Eval("one_way_fare") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
