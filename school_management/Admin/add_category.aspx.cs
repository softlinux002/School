...
public partial class Admin_add_category : System.Web.UI.Page
{
    ...
    {
        con.Open();
        //SqlCommand com = new SqlCommand("select * from add_category where category_name='" + Catname_txt.Text + "'and Description='"+Text_desc.Text+"'", con);
        SqlCommand cmd1 = new SqlCommand("add_category_proc", con);
        cmd1.CommandType = CommandType.StoredProcedure;
        cmd1.Parameters.AddWithValue("@action", "category");
        cmd1.Parameters.AddWithValue("@pk_id", "");
        cmd1.Parameters.AddWithValue("@category_name", Catname_txt.Text);
        cmd1.Parameters.AddWithValue("@Description", Text_desc.Text);
        ...
        else
        {
            ...
            //cmd.Parameters.AddWithValue("@category_name", Catname_txt.Text);
            //cmd.Parameters.AddWithValue("@Description", Text_desc.Text);
            //cmd.ExecuteNonQuery();
            inventry.inventserv obj = new inventry.inventserv();
            int a = obj.insert(Catname_txt.Text, Text_desc.Text);
            if (a > 0)
            {
    ...
    {
        //SqlDataAdapter da = new SqlDataAdapter("add_category_dlt_proc", con);
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            Catname_txt.Text = dr["category_name"].ToString();
    ...
    protected void upd_btn_Click(object sender, EventArgs e)
    {
        ...
        //cmd.ExecuteNonQuery();
        inventry.inventserv obj = new inventry.inventserv();
        int a = obj.update( Convert.ToInt32(Label_id.Text),Catname_txt.Text, Text_desc.Text);
        if (a > 0)
        {
