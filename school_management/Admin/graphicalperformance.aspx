<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="graphicalperformance.aspx.cs" Inherits="Admin_graphicalperformance" %>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12"> 
                                        <asp:DropDownList ID="examterm_ddl" class="form-control select" runat="server" AutoPostBack="true"
                           ...
                           <asp:Panel ID="Panel1" runat="server" Visible="false">
                            <div style="position:relative; text-align:center;">							                            <!-- END div align="center" class="atnd_tnav" -->							<br />														<div class="ea_pdf" style="top:15px; right:0px;">																					</div>							</div> <!-- END div class="ea_pdf" -->														                             </asp:Panel>										</div><!-- content -->	</div>
                                ...
                                <center><div class="table-responsive">
                                  <%--  <asp:PieChart ID="student_Performance" runat="server" ChartHeight="300" ChartWidth="450"  ChartTitle="Student Marks"    ChartTitleColor="#0E426C">
