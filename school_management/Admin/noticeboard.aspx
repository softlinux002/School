<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="noticeboard.aspx.cs" Inherits="Admin_noticeboard" EnableEventValidation="false" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">              
                                              ...
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                               ErrorMessage="*" ForeColor="Red" ControlToValidate="subject_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                 
                                               ...
                                               ErrorMessage="*" ForeColor="Red" ControlToValidate="notice_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>                                            
                                    ...
                                    <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                                ...
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="noticedate_txt" />
                                               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                ErrorMessage="*" ForeColor="Red" ControlToValidate="noticedate_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Notice">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_notice" runat="server" Text='<%#Eval("notice") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
