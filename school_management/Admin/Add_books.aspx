<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="Add_books.aspx.cs" Inherits="Admin_Add_books" EnableEventValidation="false"%>
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                  <asp:TextBox ID="Text_asnno" ForeColor="black" runat="server" class="form-control" ></asp:TextBox>
                                                </div>
                                            </div>
                                       
                                 <asp:Label ID="Lbl_isbn" runat="server" Text="" Visible="false"></asp:Label>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="ASN No">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbl_asn"  runat="server" Text='<%#Eval("ASN_no") %>'></asp:Label>
