<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="createcupboard.aspx.cs" Inherits="Admin_createcupboard" %>
     ...
     <asp:Label ID="lbl_sid" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Create Cupboard</strong></h3>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_name" ValidationGroup="ans">
                              ...
                              <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                ...
                                                <asp:TextBox ID="Text_detail" runat="server" class="form-control"></asp:TextBox>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_detail" ValidationGroup="ans">
         </asp:RequiredFieldValidator>
