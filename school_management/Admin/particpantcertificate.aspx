<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="particpantcertificate.aspx.cs" Inherits="Admin_particpantcertificate" %>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                        Student Name</label>
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="Text_sname" runat="server" class="form-control"> 
                            </asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                       ...
                       <asp:TextBox ID="Text_participant" runat="server" class="form-control" 
                            ></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"
                            ForeColor="Red" ControlToValidate="Text_participant" ValidationGroup="ans"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                        Description</label>
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="Text_description" runat="server" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*"
                            ForeColor="Red" ControlToValidate="Text_description" ValidationGroup="ans"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped table-actions"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Participant Title">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_ptitle" runat="server" Text='<%#Eval("participation_title") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
