...
public partial class Admin_Librarian : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            gridshow();
            blank();
            teacherno_txt.Text = GetID("select max(employee_no) from add_libraryemployee").ToString();
        }
    }   
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand com = new SqlCommand("select * from add_libraryemployee where employee_name='" + name_txt.Text + "' and father_name='" + father_txt.Text + "' and email='"+email_txt.Text+"'", con);
        ...
        else
        {
            ...
            SqlCommand cmd = new SqlCommand("add_libraryemployee_proc", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@action", "insert");
            cmd.Parameters.AddWithValue("@pk_id", "");
            cmd.Parameters.AddWithValue("@employee_no", teacherno_txt.Text);
            cmd.Parameters.AddWithValue("@joining_date", joindate_txt.Text);
            cmd.Parameters.AddWithValue("@employee_name", name_txt.Text);
            ...
            cmd.Parameters.AddWithValue("@experience_year", exyear_txt.Text);
            cmd.Parameters.AddWithValue("@experience_month", exmonth_txt.Text);
            ...
            int l = k * 256;
            pass1 = "Em" + l + "LE";
            cmd.Parameters.AddWithValue("@employee_id", pass1);
            ...
            mail.Body = "<html><head><title>Login Id Details:</title></head><body><div><br/><br/><p>Your Loginid:" + email_txt.Text + "<br/>Your Password:-" + pass + "<br/>" + "Employee id:-" + pass1 + "<br/> </div></body></Html>";
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("add_libraryemployee_dlt_proc", con);
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        {
            Image2.ImageUrl = imgg;
        }

        LinkButton lnk = (LinkButton)sender;
        GridViewRow row = (GridViewRow)lnk.NamingContainer;
        Label l1 = (Label)row.FindControl("Lbl_id");
        SqlCommand cmd = new SqlCommand("add_libraryemployee_dlt_proc", con);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        if (dr.Read())
        {
            ...
            teacherno_txt.Text = dr["employee_no"].ToString();
            joindate_txt.Text = dr["joining_date"].ToString();
            name_txt.Text = dr["employee_name"].ToString();
            ...
            exyear_txt.Text = dr["experience_year"].ToString();
            exmonth_txt.Text = dr["experience_month"].ToString();
            exdetail_txt.Text = dr["experience_detail"].ToString();
            Image2.ImageUrl = dr["image"].ToString();
            lbl_pass.Text = dr["password"].ToString();
            lbl_tid.Text = dr["employee_id"].ToString();
    ...
    protected void upd_btn_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@employee_id", lbl_tid.Text);
        cmd.Parameters.AddWithValue("@type", "Employee");
