<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="item_location.aspx.cs" Inherits="Admin_item_location" %>
    ...
    <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Item Location</strong></h3>
                                ...
                                <div class="panel-body">      
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">location_name</label>
                                        <div class="col-md-6 col-xs-12"> 
                                        <asp:TextBox ID="Text_location" runat="server" class="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" 
                  ControlToValidate="Text_location" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">item_name</label>
                                        <div class="col-md-6 col-xs-12"> 
                                            <asp:DropDownList ID="ddl_item" runat="server" class="form-control">
                                            </asp:DropDownList>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Category Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_cat" runat="server" Text='<%#Eval("location_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                       <asp:TemplateField HeaderText="Description">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_desc" runat="server" Text='<%#Eval("item_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
