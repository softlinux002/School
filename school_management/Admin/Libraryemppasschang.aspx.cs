...
public partial class Admin_Libraryemppasschang : System.Web.UI.Page
{
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        if (Session["type"].ToString() == "Librarian")
            con.Open();
        SqlCommand cmd = new SqlCommand("select * from allempdetail where password='" + Text_oldpass.Text + "'and type='Librarian'", con);
        cmd.ExecuteNonQuery();
