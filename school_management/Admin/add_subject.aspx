<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="add_subject.aspx.cs" Inherits="Admin_add_subject" EnableEventValidation="false" %>
         ...
         <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">    
                                          ...
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="subject_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12"> 
                                            <asp:DropDownList ID="section_dll" runat="server" class="form-control select">
                                            </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">           
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="teacher_ddl" ValidationGroup="ans"></asp:RequiredFieldValidator>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbl_id" Visible="false" runat="server" Text='<%#Eval("subject_id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Subject Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_fname" runat="server" Text='<%#Eval("subject_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Class">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_lname" runat="server" Text='<%#Eval("class") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Teacher">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_relation" runat="server" Text='<%#Eval("teacher") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
