<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="Insert_class.aspx.cs" Inherits="Admin_Insert_class" %>
      ...
      <asp:Label ID="Label_id" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Insert Class</strong></h3>
                                ...
                                <div class="panel-body">      
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="class_txt" runat="server" class="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="class_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Batch Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_batch" runat="server" Text='<%#Eval("class") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
