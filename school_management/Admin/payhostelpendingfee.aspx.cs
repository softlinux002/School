...
public partial class Admin_payhostelpendingfee : System.Web.UI.Page
{
    ...
    protected void student_ddl_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = new SqlCommand("select * from hostel_fee where s_id='" + student_ddl.Text + "'", con);
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = new SqlCommand("update hostel_fee set amount_pay='" + c + "' , remaining='" + Text_remaining.Text + "' where s_id='" + student_ddl.Text + "'", con);
        cmd1.ExecuteNonQuery();
        blank();
        con.Close();
    }
    ...
    protected void upd_btn_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@s_id", student_ddl.Text);
