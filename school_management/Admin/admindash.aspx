<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="admindash.aspx.cs" Inherits="Admin_admindash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-content-wrap">
        ...
        <asp:Panel ID="Panel1" runat="server">
           <div class="row">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="addclass.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="student_info.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="addcomplaint.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="teacher_info.aspx" class="tile tile-primary tile-valign">
                 ...
                 <div class="col-md-2">
                    <a href="parent_info.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="add_fee.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="add_quizquestion.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                    <a href="addevent.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="Add_driver.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Librarian.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="add_subject.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                    <a href="view_leaves.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="clerk_passchange.aspx" class="tile tile-primary tile-valign">
                    <img src="../dash/pass.jpg" height="80px" width="90px" onkeydown="return DisableControlKey(event)" onmousedown="return DisableControlKey(event)"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                           Password</p>
                        <div class="informer informer-default dir-bl">
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="generatelibrarycard.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Add_books.aspx" class="tile tile-primary tile-valign">
            ...
            <div class="row">
              <div class="col-md-2">
                    <a href="Cupboardself.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="search_book.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="Libraryemppasschang.aspx" class="tile tile-primary tile-valign">
                        <img src="../dash/pass.jpg" height="80px" width="90px"onkeydown="return DisableControlKey(event)" onmousedown="return DisableControlKey(event)"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                            Password</p>
                        <div class="informer informer-danger dir-bl">
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            ...
            <div class="row">
                 ...
                 <div class="col-md-2">
                    <a href="addhostel.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="hostelroom.aspx" class="tile tile-primary tile-valign">
                      <img src="../dash/Hostel Room.png" height="80px" width="90px"/>
                ...
                <div class="col-md-2">
                    <a href="studenthostelregister.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                    <a href="hostelrefundfee.aspx" class="tile tile-primary tile-valign">
                      <img src="../dash/fee.png" height="80px" width="90px"/>
                        <p style="font-size: 20px;font-family:Cursive;">
                            Refund Fee</p>
                        <div class="informer informer-default dir-bl">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="payhostelpendingfee.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="hostelstudentrecord.aspx" class="tile tile-primary tile-valign">
                ...
                <div class="col-md-2">
                    <a href="hostelinemppasschange.aspx" class="tile tile-primary tile-valign">
