<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="createallemployeedetail.aspx.cs" Inherits="Admin_createallemployeedetail" %>
...
<asp:Label ID="Label9" runat="server" Text="sswtechnology" Visible="false"></asp:Label>
    ...
    <asp:Label ID="lbl_tid" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Employee Detail</strong></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                     <asp:TextBox ID="emp_no" runat="server" class="form-control" ForeColor="Black" ReadOnly="true" ></asp:TextBox>
                                                </div>
                                            </div><br />
                                        ...
                                        <div class="form-group">
                                         ...
                                         <asp:DropDownList ID="DropDownList1" runat="server" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                     <asp:TextBox ID="designation" runat="server" class="form-control" ForeColor="Black" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <br />
                                        ...
                                        <asp:ListItem Text="Unmarried" Value="2"></asp:ListItem>
                                           ...
                                           <div class="form-group">                                        
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                <asp:FileUpload ID="emp_img" class="fileinput btn-primary" runat="server" /> 
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee NO">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_tno" runat="server" Text='<%#Eval("emp_no") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Joining Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_jdate" runat="server" Text='<%#Eval("doj") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Designation">
                                     ...
                                     <asp:TemplateField HeaderText="Employee name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_ename" runat="server" Text='<%#Eval("emp_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <div class="body">
        ...
        <td>
         <asp:Label ID="Label2" runat="server" Text='<%#Eval("address") %>' style="white-space: normal;"></asp:Label>
        </td>
        </tr>
        ...
        <asp:Label ID="Label_exper" runat="server" Text='<%#Eval("total_experience_year") %>' style="white-space: normal;"></asp:Label>
        </td>
        </tr>
        ...
        <td>
          <asp:Label ID="Label4" runat="server" Text='<%#Eval("experiencedetail") %>' style="white-space: normal;"></asp:Label>
        ...
        <td>
          <asp:Label ID="Label7" runat="server" Text='<%#Eval("emp_id") %>' style="white-space: normal;"></asp:Label>
