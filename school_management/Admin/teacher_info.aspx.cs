...
public partial class Admin_teacher_info : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            gridshow();
            blank();
            teacherno_txt.Text = GetID("select max(teacher_no) from teacher_info").ToString();
        }
    }
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand com = new SqlCommand("select * from teacher_info where teacher_name='" + name_txt.Text + "' and father_name='" + father_txt.Text + "' and email='"+email_txt.Text+"'", con);
        ...
        else
        {
            dr.Close();
            string imgg = "";
            if (teacher_img.HasFile)
            {
                imgg = ("~/img/" + teacher_img.FileName);
                teacher_img.SaveAs(Server.MapPath("~/img/") + teacher_img.FileName);
            }
            //SqlCommand cmd = new SqlCommand("teacher_proc", con);
            //cmd.CommandType = CommandType.StoredProcedure;
            //cmd.Parameters.AddWithValue("@action", "insert");
            //cmd.Parameters.AddWithValue("@teacher_id", "");
            //cmd.Parameters.AddWithValue("@teacher_no", teacherno_txt.Text);
            //cmd.Parameters.AddWithValue("@joining_date", joindate_txt.Text);
            //cmd.Parameters.AddWithValue("@teacher_name", name_txt.Text);
            //cmd.Parameters.AddWithValue("@designation", Text_designation.Text);
            ...
            int a = obj.insert(teacherno_txt.Text, joindate_txt.Text, name_txt.Text, Text_designation.Text, father_txt.Text, gender_ddl.SelectedItem.ToString(), dob_txt.Text, ddl_country.SelectedItem.ToString(),
               ddl_state.SelectedItem.ToString(), ddl_city.SelectedItem.ToString(), addres1_txt.Text, mob_txt.Text, email_txt.Text, martial_ddl.SelectedItem.ToString(),
               blood_txt.Text, exyear_txt.Text, exmonth_txt.Text, exdetail_txt.Text, salary_txt.Text, pass, pass1, imgg, "teacher");
            if (a > 0)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "test", "alert('Thanks For Registartion!!!!');", true);
    ...
    {
        //SqlDataAdapter da = new SqlDataAdapter("teacher_dlt_proc", con);
        //da.SelectCommand.CommandType = CommandType.StoredProcedure;
        //da.SelectCommand.Parameters.AddWithValue("@action", "show");
        //da.SelectCommand.Parameters.AddWithValue("@teacher_id", "");
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@teacher_id", l1.Text);
        ...
        if (dr.Read())
        {
            Label_id.Text = dr["teacher_id"].ToString();
            teacherno_txt.Text = dr["teacher_no"].ToString();
            joindate_txt.Text = dr["joining_date"].ToString();
            name_txt.Text = dr["teacher_name"].ToString();
            Text_designation.Text = dr["designation"].ToString();
    ...
    protected void upd_btn_Click(object sender, EventArgs e)
    {
        ...
        //cmd.Parameters.AddWithValue("@teacher_id", Label_id.Text);
        //cmd.Parameters.AddWithValue("@teacher_no", teacherno_txt.Text);
        //cmd.Parameters.AddWithValue("@joining_date", joindate_txt.Text);
        //cmd.Parameters.AddWithValue("@teacher_name", name_txt.Text);
        //cmd.Parameters.AddWithValue("@designation", Text_designation.Text);
        ...
        //cmd.Parameters.AddWithValue("@teacher_tid", lbl_tid.Text);
        //cmd.Parameters.AddWithValue("@image", imgg);
        //cmd.Parameters.AddWithValue("@type", "teacher");
        //cmd.ExecuteNonQuery();
        teacherservice.teachersev obj = new teacherservice.teachersev();
        int a = obj.update(Convert.ToInt32(Label_id.Text),teacherno_txt.Text, joindate_txt.Text, name_txt.Text, Text_designation.Text, father_txt.Text, gender_ddl.SelectedItem.ToString(), dob_txt.Text, ddl_country.SelectedItem.ToString(),
           ddl_state.SelectedItem.ToString(), ddl_city.SelectedItem.ToString(), addres1_txt.Text, mob_txt.Text, email_txt.Text, martial_ddl.SelectedItem.ToString(),
           blood_txt.Text, exyear_txt.Text, exmonth_txt.Text, exdetail_txt.Text, salary_txt.Text, lbl_pass.Text, lbl_tid.Text, imgg, "teacher");
        if (a > 0)
        {
