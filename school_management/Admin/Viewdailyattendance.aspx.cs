...
public partial class Admin_Viewdailyattendance : System.Web.UI.Page
{
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into dailyattandance values('" + DateTime.Now.ToString() + "','" + batch_ddl.SelectedItem.ToString() + "','" + stream_ddl.SelectedItem.ToString() + "','" + class_ddl.SelectedItem.ToString() + "','" + section_ddl.SelectedItem.ToString() + "','" + rollno.Text + "','" + name.Text + "','" + a + "')", con);
            cmd.ExecuteNonQuery();
