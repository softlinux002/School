...
public partial class Admin_Tabulationmarksheet : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select distinct roll_no from studentinfo where batch='" + Batch_dll.SelectedItem.ToString() + "' and  class='" + class_ddl.SelectedItem.ToString() + "' and section='" + section_ddl.SelectedItem.ToString() + "'and stream='"+streamddl.SelectedItem.ToString()+"'", con);
        DataTable dt = new DataTable();
        da.Fill(dt);
