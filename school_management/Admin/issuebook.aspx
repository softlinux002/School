<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="issuebook.aspx.cs" Inherits="Admin_issuebook" EnableEventValidation="false"%>
             ...
             <asp:Panel ID="Panel4" runat="server" Visible="false">
                                 ...
                                 <asp:Panel ID="Panel1" runat="server" Visible="false">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                             ...
                                             <asp:TextBox ID="Text_batch" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"
                                                     ></asp:TextBox>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                  ...
                                                  <asp:TextBox ID="Text_class" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"
                                                     ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                ...
                                                <asp:TextBox ID="Text_section" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"
                                                     ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                              <asp:TextBox ID="Text_stream" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"
                                                     ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                ...
                                                <asp:TextBox ID="Text_roll" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"
                                                     ></asp:TextBox>
