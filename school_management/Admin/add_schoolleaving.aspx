<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="add_schoolleaving.aspx.cs" Inherits="Admin_add_schoolleaving" %>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <strong>Provide School Leaving Certificate</strong></h3>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <asp:DropDownList ID="ddl_father" runat="server" class="form-control" OnSelectedIndexChanged="ddl_father_selectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="admisn_txt" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*"
                            ForeColor="Red" ControlToValidate="admisn_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                        Birth Date</label>
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="dob_txt" runat="server" class="form-control" ReadOnly="true" ForeColor="Black"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="doa_txt" runat="server" class="form-control"></asp:TextBox>
                        <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="doa_txt">
                        </asp:CalendarExtender>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*"
                            ForeColor="Red" ControlToValidate="doa_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                        Reason</label>
                    <div class="col-md-6 col-xs-12">
                        <asp:TextBox ID="reason_txt" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
                        
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*"
                            ForeColor="Red" ControlToValidate="reason_txt" ValidationGroup="ans"></asp:RequiredFieldValidator>
                    </div>
                </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped table-actions"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Admission Date">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_admissiondate" runat="server" Text='<%#Eval("admission_date") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="DOB">
                              ...
                              <asp:TemplateField HeaderText="Date of Apllication">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_doa" runat="server" Text='<%#Eval("date_of_application") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                              <asp:TemplateField HeaderText="Date of issue">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_dateofissue" runat="server" Text='<%#Eval("date_of_issue") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
