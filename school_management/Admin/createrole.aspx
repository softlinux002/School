<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="createrole.aspx.cs" Inherits="Admin_createrole" %>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">      
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="Tb_rname" runat="server" class="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Tb_rname" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                            ...
                            AllowPaging="true" PageSize="10" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbl_id" Visible="false" runat="server" Text='<%#Eval("role_id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Menu_name">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_name" runat="server" Text='<%#Eval("role_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
