<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="Return_book.aspx.cs" Inherits="Library_Return_book" %>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                 ...
                                                 <asp:TextBox ID="Text_return" runat="server" class="form-control" 
                                                    ...
                                                    <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="Text_return">
                                                    </asp:CalendarExtender>
