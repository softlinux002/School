<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="Cupboard_shelf.aspx.cs" Inherits="Library_Cupboard_shelf" %>
     ...
     <asp:Label ID="lbl_sid" runat="server" Text="" Visible="false"></asp:Label>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Cupboard Shelf</strong></h3>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_name" ValidationGroup="ans"></asp:RequiredFieldValidator>                                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                              ...
                                              <asp:DropDownList ID="cupboard_ddl" runat="server" class="form-control">
                                                 </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                ...
                                                <asp:TextBox ID="Text_cpacity" runat="server" class="form-control"></asp:TextBox>
                                 
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_cpacity" ValidationGroup="ans"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                              ...
                              <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                ...
                                                <asp:TextBox ID="Text_detail" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                               <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="Text_detail" ValidationGroup="ans">
