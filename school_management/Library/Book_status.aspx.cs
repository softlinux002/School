...
public partial class Library_Book_status : System.Web.UI.Page
{
    ...
    protected void submit_btn_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Book_status_proc", con);
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Book_status_event_proc", con);
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Book_status_event_proc", con);
        cmd.CommandType = CommandType.StoredProcedure;
